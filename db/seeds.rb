...
admin = User.create( email_address: 'admin@example.com', password: 'password', role: 'admin', name: 'Adam the Admin', street_address: '123 Example St', city: 'Userville', state: 'State 1', zip_code: '12345')
merchant = User.create( email_address: 'merchant@example.com', password: 'password', role: 'merchant', name: 'Mary the Merchant', street_address: '123 Example St', city: 'Userville', state: 'State 1', zip_code: '12345')
user = User.create( email_address: 'user@example.com', password: 'password', role: 'default', name: 'Ulysses the User', street_address: '123 Example St', city: 'Userville', state: 'State 1', zip_code: '12345')
